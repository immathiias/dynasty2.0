...
const foramenu = document.getElementById('foramenu')

function foraMenu(){
  if(nav.getAttributeNames('show')){
    nav.classList.remove('show')
    return;
  }
}
foramenu.addEventListener('click', foraMenu)
...
const copyip = document.getElementById('ipCopy')
const copiado = document.querySelector('.copiarip .copyz')
